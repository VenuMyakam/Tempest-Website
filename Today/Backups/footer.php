<?php if (!is_page('thank-you')) { ?>
    ...
    <section style="margin-top: -10px;">
        <div class="container-fluid"
            style="background: rgb(230,59,39);background: linear-gradient(178deg, rgb(227 44 22) 25%, rgb(188 13 13) 100%);">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div id="grad1sp" style="width: 100%;">
                        <div class="headersp" style="">
                            <p class="tempest-foorbannertxt">Creating a system for brands that generate long-term success
                                stories is what Tempest focuses upon. This is what makes us<br /> the <a
                                    ...
                                    target="_blank" class="ref-linksp">digital marketing agency</a> in Hyderabad, Pune &
                                Bangalore.</p>
                            <a href="#" data-toggle="modal" data-target="#myModalFullscreen" contenteditable="false"
                                class="btn-bgstrokesp" style="">Let's Connect</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php } ?>
<?php //if ( is_page_template( 'single-careers.php' ) ) { ?>
...
<section class="footer">
    <div class="container mb-pl-pr ">
        <div class="row">
            <div class="col-md-4 col-xs-12 col-sm-4 mb-pl-pr foot-cum-wi">
                ...
                <div class="col-md-6 col-xs-12 col-sm-4 px-8 f-pl-pr">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6 col-sm-5">
                            <?php wp_nav_menu(array('theme_location' => 'footer', 'container' => '', 'menu_class' => 'list-unstyled')); ?>
                        </div>
                        <div class="col-md-6 col-xs-6 col-sm-7">
                            <?php wp_nav_menu(array('theme_location' => 'footertwo', 'container' => '', 'menu_class' => 'list-unstyled')); ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="right-con">
                        ...
                        <div class="tab-container">
                            ...
                            <div id="tab-1" class="tab-content">
                                <?php echo do_shortcode('[contact-form-7 id="277" title="Business"]'); ?>
                            </div>
                            <!--Business Form Close here
-->
                            <div id="tab-2" class="tab-content">
                                <?php echo do_shortcode('[contact-form-7 id="278" title="Media"]'); ?>
                            </div>
                            <div id="tab-3" class="tab-content">
                                <?php echo do_shortcode('[contact-form-7 id="276" title="Openings"]'); ?>
                            </div>
                            <div id="tab-4" class="tab-content">
                                <?php echo do_shortcode('[contact-form-7 id="279" title="internship"]'); ?>
                            </div>
                        </div>
                        <div class="pop-con">
...
<!--                    <img src="https://www.tempestadvertising.com/wp-content/themes/tempestadvertising/images/Tempest_Speaker_Post_Session_17.jpg"-->
...
<!--            <div class="modal-header">-->
<!--                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>-->
<!--                <h5 class="modal-title">Acing Advertising for the last 25 years</h5>-->
<!--            </div>-->
<!--            <div class="modal-body">-->
<!--                <img class="img-responsive" src="https://www.tempestadvertising.com/wp-content/uploads/2023/06/t25.png" alt="">-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
...
<div id="Celebration" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h5 class="modal-title">Winners</h5>
            </div>
            <div class="modal-body">
                <img class="img-responsive" src="https://www.tempestadvertising.com/wp-content/uploads/2023/08/winners.webp" alt="">
            </div>
        </div>
    </div>
</div>
...
<script>
  ...
  $(document).ready(function(){
        ...
        $("#Celebration .close").on('click', function(){
